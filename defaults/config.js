...
module.exports = {
	...
	// [use a reverse proxy instead](https://arp.systems/docs/guides/reverse-proxies).
	//
	...
	// [here](https://arp.systems/docs/guides/theme-creation).
	//
	...
	// one.
	//
	// This value is set to `"The Lounge - https://arp.systems"` by
	// default.
	leaveMessage: "aRp Systems- http://www.arp.systems",
	...
	defaults: {
		name: "Freenode",
		host: "chat.arp.systems",
		port: 6667,
		password: "",
		tls: false,
		rejectUnauthorized: false,
		nick: "useraRpSystems%%",
		username: "www.aRp.systems",
		realname: "aRp Systems User",
		join: "#music",
	},
