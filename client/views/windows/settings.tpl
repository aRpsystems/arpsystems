...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12" id="native-app" hidden>
			...
			<button type="button" class="btn" id="webapp-install-button" hidden>Add aRp Systems to Home screen</button>
			<button type="button" class="btn" id="make-default-client">Open http://music.arp.ninja</button>
		</div>
